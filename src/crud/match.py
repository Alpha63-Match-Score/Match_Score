...
from src.crud.team import leave_top_teams_from_robin_round
from src.crud.tournament import update_tournament_stage
...
def update_match_score(
    ...
    try:
        ...
        v.match_shouldnt_be_finished(db_match)
