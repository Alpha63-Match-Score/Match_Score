...
def create_player(
    ...
    v.user_exists(db, user_email=player.user_email, detail="No user with such email exists")
    v.team_exists(db, team_name=player.team_name, detail="No team with such name exists")
